...
class Bunyad_Theme_Admin_Dashboard
{
	...
	{
		// Dismissed?
		$dismissed = get_transient('bunyad_dismiss_activation');

		if (Bunyad::core()->get_license() OR $dismissed) {
			return false;
		}
	...
	public function dismiss_notice()
	{
		...
		if (check_admin_referer('bunyad_dismiss_activation')) {
			set_transient('bunyad_dismiss_activation', 1);
		}
