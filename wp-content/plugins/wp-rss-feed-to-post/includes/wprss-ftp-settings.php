...
/*===== SETTINGS GETTERS =================================================================================*/
    ...
    public function get_defaults() {
        ...
        return apply_filters('wprss_ftp_default_settings', array(
            ...
            'add_content_in_feed'       => false,                   # Whether or not to add custom content in the feed
...
#== SETTINGS REGISTRATION =====================================================================================
    ...
    public function register_settings() {
        ...
        add_settings_field(
            ...
            array( $this, 'render_add_content_in_feed' ),
            'wprss_settings_ftp',
            'wprss_settings_ftp_general_section'
        );
...
#== FIELD RENDERERS =================================================================================
     ...
     * @since 3.12
     */
    public function render_source_link_position( $args ) {
     ...
     * @since 3.12
     */
    public function render_add_content_in_feed( $args ) {
